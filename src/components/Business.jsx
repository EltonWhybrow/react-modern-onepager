        ...
        <section id="features" className={layout.section}>
            <div className={layout.sectionInfo}>
                ...
                <p className={`${styles.paragraph} max-w-[470px] t-5`}>
                    With the right credit card, you can improve your finacial life by building credit, earning rewrds and saving money. But with hundreds of credit cards on the market.</p>
