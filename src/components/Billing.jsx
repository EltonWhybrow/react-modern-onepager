    ...
    <section className={` ${layout.sectionReverse}`}>
        ...
        <div className={` ${layout.sectionInfo}`}>
            ...
            <p className={` ${styles.paragraph}`}>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Commodi natus ullam repudiandae. Eveniet quod earum consectetur voluptas officiis debitis corporis architecto distinctio eos, omnis temporibus ut dicta voluptatum. Nihil aut optio magnam.
            </p>
